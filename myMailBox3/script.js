...
class UI {
  ...
  static clearFields(){
    document.querySelector('#cle').value = '';
...
class Store {
  static getBooks() {
      ...
      if(localStorage.getItem('contacts') === null) {
        ...
        books = JSON.parse(localStorage.getItem('contacts'));
      }
...
document.querySelector('#book-form').addEventListener('submit',(e) => {
  ...
  const cle = document.querySelector('#cle').value;
...
function genererCle(){
    document.getElementById("cle").value = generateId();
}
